    ...
    <div className="min-h-screen bg-gradient-light flex items-center justify-center p-4">
      <Card className="max-w-md w-full shadow-card border-0 bg-card/80 backdrop-blur-sm">
        <CardHeader className="text-center">
          ...
          <p className="text-muted-foreground">Cadastre-se para acessar todas as funcionalidades</p>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Button variant="outline" onClick={onGithubSignup}>
          ...
          <div className="text-center">
            <p className="text-sm text-muted-foreground">
              Já tem uma conta?{' '}
              <Button variant="link" onClick={onBack} className="p-0 h-auto text-primary">
                Fazer login
              </Button>
            </p>
          </div>
